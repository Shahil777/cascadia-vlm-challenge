...
Vision–Language Model challenge solution for Cascadia board game scoring. Includes visual reasoning, rule-based wildlife scoring, reproducible analysis, and clear winner determination.
Title: Cascadia Vision–Language Model (VLM) Challenge – Phronetic AI

Description:

This repository contains my submission for the Vision–Language Model (VLM) Challenge as part of the Machine Learning Scientist hiring process at Phronetic AI.
...
Input images (final player boards and scoring cards)

A reproducible Google Colab notebook with step-by-step reasoning
